...
***Important*** The example files described were provided for the CRUK Bioinformatics Summer School; Analysis of Cancer Genomes - July 2017. If you do not see any `.fastq` files listed in the directory, you will need to download them. A script `download-test-data.sh` is provided for this purpose:-

```{}
sh /home/participant/Course_Materials/download-test-data.sh
```
