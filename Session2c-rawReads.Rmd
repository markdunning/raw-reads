...
- View the `fastqc` report for our example file `sample.fq1`
    + see the start of this section for how to run the `fastqc` tool
...
```{}
bwa sampe ../ref_data/Homo_sapiens_assembly19.fasta sample_1.sai sample_2.sai sample.fq1 sample.fq2 > sample.sam 
```
